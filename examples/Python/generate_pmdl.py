...
def main():
    ...
    parser.add_argument('-r1', '--record1', dest="record1", required=False, help="Record voice 1")
    parser.add_argument('-r2', '--record2', dest="record2", required=False, help="Record voice 2")
    parser.add_argument('-r3', '--record3', dest="record3", required=False, help="Record voice 3")
